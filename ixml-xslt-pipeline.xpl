...
<p:declare-step name="onepiece-to-XML" xmlns:p="http://www.w3.org/ns/xproc"
    ...
    <!-- ================================================================ -->
    <p:directory-list name="sourceColl" path="transliterationFiles" detailed="true"/>
    ...
    <p:invisible-xml cx:processor="markup-blitz">
        <p:with-input port="grammar">
            <p:document href="ixml/translit.ixml" content-type="text/plain"/>
    ...
    <p:store href="xml/{$filename}.xml" serialization="map {
        'method' : 'xml',
        'indent' : true(),
