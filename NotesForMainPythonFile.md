# Things for Main Python File

## Get Original File
```
with open('../transliterationFiles/ZL3b-n/ZL3b-n.txt', 'r') as file:
  filedata = file.read()
```
...
# Run the function
new_xml = process_tei_hands(filedata)
```


## Change to UTF-8
```
with open('../transliterationFiles/ZL3b-n/ZL3b-n.txt', 'w', encoding='utf-8') as file:
  file.write(filedata)
```  
